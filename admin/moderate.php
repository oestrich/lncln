	...
	?>
		<div id="<?=$image['id'];?>" class="modDiv">
			...
			<div class="modForms">
				...
				Tags:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name='tags' value="<?=$tags;?>" onchange="modCheck('<?=$image['id'];?>')"/><br />
				Caption:&nbsp;<textarea name="caption" rows="10" cols="50" wrap="off" onchange="modCheck('<?=$image['id'];?>')"><?=$image['caption'];?></textarea><br />
				Album:&nbsp;&nbsp;&nbsp;
				<select name="album" onchange="modCheck('<?=$image['id'];?>')">
