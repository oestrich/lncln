...
<form enctype="multipart/form-data" action="index.php?post=true" method="post"  id="form" style="display: none;">
	<div>
		...
		Obscene<br />
		<input name="upload0check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload1check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload2check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload3check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload4check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload5check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload6check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload7check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload8check" type="checkbox" value='true'/>
		...
		<br />
		<input name="upload9check" type="checkbox" value='true'/>
